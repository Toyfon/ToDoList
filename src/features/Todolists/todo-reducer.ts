...
import {getTasks} from "./task-reducer";
...
export const changeTodoListTitleAC = (id: string, title: string) => ({
    type: "TODOS/CHANGE-TODOLIST_TITLE", payload: {title, id}
} as const)
export const changeTodoListFilterAC = (id: string, filter: FilterValuesType) => ({
    type: "TODOS/CHANGE-TODOLIST_FILTER", payload: {filter, id}
} as const)
export const changeTodoListEntityStatusAC = (id: string, entityStatus: StatusType) => ({
    type: "TODOS/CHANGE-TODOLIST_ENTITY_STATUS", payload: {entityStatus, id}
} as const)
export const clearReduxState = () => ({type: "TODOS/CLEAR-TODOS-DATA"} as const)
...
export type clearReduxStateACType = ReturnType<typeof clearReduxState>
